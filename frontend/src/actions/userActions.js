...
//Login
// we will get this email and password from login.jsx
// This login function is an asynchronous Redux action that handles the login process
export const login = (email, password) => async (dispatch) => {
    try {
        ...
        // all user data will come here in destructured format as we have done {data}
...
export const register = (userData) => async (dispatch) => {
    try {
        ...
        return data.data.user;  //usefull if the calling function needs data
